    ...
    public class ProductoService : IProductoService
    {
        ...
        public async Task<List<ProductoDTO>> Lista()
        {
            try
            {
                ...
                var listaProductos = queryProductos.Include(p => p.IdCategoriaNavigation).ToList();
        ...
        public async Task<bool> Editar(ProductoDTO modelo)
        {
            try
            {
                Producto productoModelo = _mapper.Map<Producto>(modelo);

                Producto productoEncontrado = await _productoRepositorio.Obtener(p => p.IdProducto == modelo.IdProducto);
                ...
                if (respuesta == false) throw new TaskCanceledException("No se pudo editar");
        ...
        public async Task<bool> Eliminar(int id)
        {
            try
            {
                Producto productoEncontrado = await _productoRepositorio.Obtener(p => p.IdProducto == id);
